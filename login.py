...
class Ui_MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.btnIngresarLogin.clicked.connect(self.RegistraUsuario)
    
    def RegistraUsuario(self):
        try:
                self.nombre = self.txtInputNombre.text()
                self.dni = self.txtInputDNI.text()
                
                usuario = UsuarioModel(
                        Usuario_Nombre = self.nombre,
                        Usuario_DNI = self.dni
                )
                ...
                messagebox.showerror("Configuración", "Por favor ingrese valores numéricos validos")
