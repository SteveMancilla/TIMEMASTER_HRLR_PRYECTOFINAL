...
circulo1 = canvas1.create_rectangle(10,10,100,100, outline='red2',width=10)
circulo2 = canvas2.create_rectangle(10,10,100,100, outline='medium spring green',width=10)
circulo3 = canvas3.create_rectangle(10,10,100,100, outline='magenta2',width=10)
